...
function getBusinessContext() {
    return {
        ...
        avoidWords: ["неймовірно", "дивовижно", "ми в захваті", "дякуємо, що знайшли час", "високі стандарти", "велика мотивація", "найвищий рівень", "Ваші слова є для нас найкращою нагородою"]     
